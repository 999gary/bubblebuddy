...
cl ..\source\main.c /DWIN32_NO_CRT /Febubblebuddy.exe /Gm- /GR- /EHa- /GS- /Gs9999999 /O2 /Oi /link /STACK:0x100000,0x100000 /NODEFAULTLIB /incremental:no /opt:ref kernel32.lib shell32.lib user32.lib gdiplus.lib shlwapi.lib d3d9.lib Comdlg32.lib
